...
[![Tests](https://github.com/openedx-actions/tutor-k8s-configure-redis/actions/workflows/testRelease.yml/badge.svg)](https://github.com/openedx-actions/tutor-k8s-configure-redis/actions)
  ...
  build:
    ...
    steps:
      ...
      - name: Configure remote Redis service
        uses: openedx-actions/tutor-service-configure-redis@v1.0.1
        with:
          namespace: openedx-prod
